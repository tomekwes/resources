...
require('packer').startup(function(use)
  ...
  use 'nvim-treesitter/nvim-treesitter-context' -- alwyays show fn declaration
  ...
  use 'tpope/vim-unimpaired' -- mappings for quick fix list
...
require('nvim-treesitter.configs').setup {
    ...
    ensure_installed = { 'c', 'cpp', 'go', 'lua', 'bash', 'python', 'rust', 'vimdoc', 'vim', 'json' },
...
vim.api.nvim_command("au BufRead,BufNewFile *.ptw       set filetype=qmljs")
